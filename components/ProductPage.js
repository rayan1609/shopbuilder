    ...
    <div className="product-page-overlay">
      <div className="product-page">
        ...
        <div className="urgency-bar">
          🔥 <strong>23 personnes</strong> regardent ce produit en ce moment · Stock limité : <strong>14 restants</strong>
        </div>
        ...
        <div className="pp-main">
          ...
          <div className="pp-info">
            <div className="pp-reviews-summary">
              {'⭐'.repeat(5)} <span>4.8/5</span> <span className="pp-review-count">(127 avis)</span>
            </div>
            ...
            <div className="pp-bundles">
              ...
              {bundles.map((b, i) => (
                <div
                  key={i}
                  className={`pp-bundle ${selectedBundle === b.qty ? 'selected' : ''}`}
        ...
        <div className="pp-sticky-cta">
          <div className="pp-sticky-info">
            <span className="pp-sticky-price">{selectedBundleData.price.toFixed(2)}€</span>
            <span className="pp-sticky-label">{selectedBundleData.label}</span>
          </div>
          <button className="pp-cta" style={{ flex: 1 }}>
            🛒 Ajouter au panier
          </button>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .pp-sticky-price { font-size: 18px; font-weight: 800; }
        .pp-sticky-label { font-size: 12px; color: #888; display: block; }
        ...
        @media (max-width: 768px) {
          ...
          .pp-guarantees { grid-template-columns: 1fr 1fr; }
  ...
  return (
    <div style={{ border: '1px solid #eee', borderRadius: 10, overflow: 'hidden', marginBottom: 8 }}>
      <button
        ...
        style={{ width: '100%', padding: '14px 16px', background: open ? '#f8f8f8' : '#fff', border: 'none', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontWeight: 600, fontSize: 14, color: '#111', textAlign: 'left' }}
      >
        {q}
